<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Sprout Studio" width="144" />
  </picture>
</p>
...
**App:** [Install](ryu://apps/@ryu/reelfarm) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/reelfarm
```
